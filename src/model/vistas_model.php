...
class vistaModelo
{
    protected static function obtener_vista($vista)
    {
        ...
        $palabras_permitidas_n1 = ['inicio', 'usuarios', 'nuevo-usuario','clientes','nuevo-cliente','proyectos','nuevo-proyecto','nuevo-token-api','tokens-api','clientes-api','nuevo-cliente-api','consultas-api'];
